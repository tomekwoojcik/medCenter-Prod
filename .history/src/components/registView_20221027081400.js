...
export default function RegistView() {
    ...
    return (
        <div className="login_container">
            ...
            <form className="regist" onSubmit={signUp}>
                ...
                <input className="input" name="email" type="email" value={email} onChange={setEmail((e) => { e.target.value })} />
                <label className="label_register">Hasło:</label>
                <input className="input" name="password" type="password" value={password} onChange={setPasword((e) => { e.target.value })} />
