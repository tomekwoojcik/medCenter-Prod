...
export const AuthContextProvider = ({ children }) => {
    ...
    const getDataMed = () => {
        const medCollection = collection(db, 'MedProfession', 'Pediatra', "Pediatra-1", "qt3XkDrE1iw42b8JQfX9");
    ...
    console.log(dataMed);
    return (
        <UserContext.Provider value={{ createUser, user, logout, signIn, states, handleButton, cities, handleCityButton, dataMed }}>
            {children}
