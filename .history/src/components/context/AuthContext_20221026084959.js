...
import { createUserWithEmailAndPassword, onAuthStateChanged, getAuth, signInWithEmailAndPassword, signOut, sendPasswordResetEmail } from "firebase/auth";
...
export function AuthProvider({ children }) {
    ...
    return (
        <authContext.Provider value={{ register, login, user, logout, loading, resetPassword }}>
            {children}
