...
export const AuthContextProvider = ({ children }) => {
    ...
    const uniqeArr = uniqeArrStateNFZ.filter(el => { return el !== undefined && "Łódzki OW NFZ" })
    ...
    const filtrData = (checkCity) => {
        setFiltrElements(medHospital.filter(el => { return el.data.NfzName.includes(checkCity) }))
