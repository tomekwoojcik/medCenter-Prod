...
export const AuthContextProvider = ({ children }) => {
    ...
    const filtrData = (checkCity) => {
        ...
        // setDataMed(filtrElements) zrobić aby wyswietlało elementy w oknie wyszukiwania
    }
    //---------------------------------------------------------------------------
    let arrCityHospital = [];
    ...
    console.log(uniqeArrCityHospital);
    ...
    const handleHospitalInCityButton = (el) => {
        ...
        filtrDataHospitalInCity(checkCity);
    }

    const [filtrHospitalInCity, setFiltrHospitalInCity] = useState([])

    const filtrDataHospitalInCity = (checkCity) => {
        setFiltrHospitalInCity(medHospital.filter(el => {
            return el.data.NfzCity.includes(checkCity);
    ...
    return (
        <UserContext.Provider value={{ createUser, user, logout, signIn, states, handleButton, cities, handleCityButton, dataMed, medPerson, handleProfesion, medHospital, lastNfzUniqeArr, filtrElements, uniqeArrCityHospital, handleHospitalInCityButton }}>
            {children}
