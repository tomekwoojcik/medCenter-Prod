...
export const AuthContextProvider = ({ children }) => {
    ...
    const API_URL =
        "https://api.airvisual.com/v2/states?country=Poland&key=31c5ee2a-1fe1-4bb3-8d01-d0b5160d5d29";
    const API_URL_CITY = (state = "Mazovia") =>
        `https://api.airvisual.com/v2/cities?state=${state}&country=Poland&key=31c5ee2a-1fe1-4bb3-8d01-d0b5160d5d29`;
            ...
            try {
                ...
                !!states.length &&
                    states.map(async (state) => {
                        ...
                        setCities((prevState) => {
                            list: [...prevState.list, responseCities];
                        });
    ...
    return (
        <UserContext.Provider value={{ createUser, user, logout, signIn, state, handleButton, cities, handleCityButton }}>
            {children}
