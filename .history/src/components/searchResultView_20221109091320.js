                    ...
                    <div key={el.id} className="med_person">
                        <div className="inner">
                            ...
                            <div className="registration" >
                                {user !== null ? <Button value={el.id} onClick={handleRegistration(value)} className="button" color="primary" variant="contained">Zarejestruj się do lekarza</Button> : <Button href="/loginView" className="button" color="primary" variant="contained">Zaloguj</Button>}
                            </div>
                        </div>
