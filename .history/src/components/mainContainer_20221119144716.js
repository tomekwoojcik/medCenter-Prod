...
export default function MainContainer() {
    ...
    return (
        <div className="main_container">
            ...
            <Router>
                <div>
                    <Link to="main" className="menu_items"><DashboardIcon className="dash_Board" />Okno główne</Link>
                    <Link to="searchDoctorView" className="menu_items"><SearchIcon className="dash_Board" />Wyszukaj lekarza</Link>
                    <Link to="searchHospitalView" className="menu_items"><LocalHospitalIcon className="dash_Board" />Wyszukaj poradnię</Link>
                </div>
                <Routes>
