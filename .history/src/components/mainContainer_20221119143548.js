...
export default function MainContainer() {
    ...
    return (
        <div className="main_container">
            ...
            <Router>
                <Link href="main" className="menu_items">Okno główne</Link>
                <Link href="searchDoctorView" className="menu_items">Wyszukaj lekarza</Link>
                <Link href="searchHospitalView" className="menu_items">Wyszukaj poradnię</Link>
                <Routes>
