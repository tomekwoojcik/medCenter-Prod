    ...
    return (
        <div className="aside">
            ...
            <span className="line" >
                ...
                {user !== null ? <Button href="/loginView" className="button" color="primary" variant="contained">Wyloguj</Button> : <Button href="/loginView" className="button" color="primary" variant="contained">Zaloguj</Button>}
                {/* <Button href="/loginView" className="button" color="primary" variant="contained"></Button> */}
            </span>
        </div>)
}