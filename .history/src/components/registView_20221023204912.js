    ...
    return (
        <div className="login_container">
            ...
            <form className="regist">
                ...
                <Button onSubmit={handleSubmit} onClick={register} type="submit" className="register_button" color="secondary" variant="contained" endIcon={<SendIcon />}>Zarejestruj</Button>
            </form>
