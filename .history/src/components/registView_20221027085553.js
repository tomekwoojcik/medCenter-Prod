    ...
    return (
        <div className="login_container">
            ...
            <form className="regist" onSubmit={handleSubmit}>
                ...
                <input className="input" type="text" value={email} onChange={(e) => { setFirstName(e.target.value) }} />
                <label className="label_register">Drugię imię:</label>
                <input className="input" type="text" ovalue={email} onChange={(e) => { SetSecondName(e.target.value) }} />
                <label className="label_register">Nazwisko:</label>
                <input className="input" type="text" value={email} onChange={(e) => { setLastName(e.target.value) }} />
                <label className="label_register">Pesel:</label>
                <input className="input" type="text" value={email} onChange={(e) => { setPesel(e.target.value) }} />
