                ...
                return (
                    <div key={el.id} className="med_person">
                        <div className="inner">
                            ...
                            {contextList !== true ? <Button onClick={no} variant="text">Lista leczonych chorób:</Button> : <Button onClick={yes} variant="text">Ukryj liste leczonych chorób:</Button>}

                            <div className="other_info">

                                {contextList !== true ? BlindList : List}
                                {/* <ul className="list_diseases">
