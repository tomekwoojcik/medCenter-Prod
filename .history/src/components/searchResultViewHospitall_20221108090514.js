...
const SearchResultViewHospitall = () => {
    const { medHospital, filtrElements } = UserAuth()
    return (

        <div className="search_container">
            <Router>
                <Routes>
                    {/* <Route path="/" element={<Page array={medHospital} />} ></Route > */}
                    <Route path="searchNfzOw" element={<Page array={filtrElements} />} ></Route >
