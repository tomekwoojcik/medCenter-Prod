        ...
        <div className="main_container">
            ...
            <Router>
                <div className="menu">
                    ...
                    {user !== null ? <Link onClick={handleLogout} className="button" color="primary" variant="contained">Wyloguj</Link> : <Link to="/loginView" className="button" color="primary" variant="contained">Zaloguj</Link>}
                </div>
                <Routes>
