                    ...
                    <div key={el.id} className="med_person">
                        <div className="inner">
                            ...
                            <div className="registration" >
                                {user !== null ? <Button onClick={handleLogout} className="button" color="primary" variant="contained">Zarejestruj się do lekarza</Button> : <Button href="/loginView" className="button" color="primary" variant="contained">Zaloguj</Button>}
                            </div>
                        </div>
