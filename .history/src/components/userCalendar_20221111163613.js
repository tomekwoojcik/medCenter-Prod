        ...
        <div className="login_container">
            <div className="in_box_calendar">
                ...
                <div className="pending_registrations">
                    <h3>Lista oczekujących rejestracji</h3>
                ...
                <div className="ready_registrations">
                    <h3>Lista gotowych rejestracji</h3>
                    <div className="in_box_message">
                        {
                                ...
                                return (person.map((thr) => {
                                    return (
                                        <div className="notification_message" key={first.id}>
                                            ...
                                            <p>Data rejestracji: <span className="noti_person">{`${first.data.dateOfTheVisit}`}</span> </p>
                                            <p>Data rejestracji: <span className="noti_person">{`${first.data.hourOfTheVisit}`}</span> </p>
                                        </div>
                                    )
                                }))
